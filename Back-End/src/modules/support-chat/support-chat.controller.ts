...
export class SupportChatController {
  ...
  async submitMessage(@Request() req: any, @Body() dto: CreateSupportMessageDto) {
    try {
      ...
      console.error("[Controller] submitMessage FULL ERROR:", err);
      console.error("[Controller] submitMessage stack:", err.stack);
  ...
  async getAdminTickets(@Request() req: any) {
    ...
    // Returns ALL escalated tickets across all businesses, sorted by date DESC
  ...
  @Get("admin/tickets/:id")
  @UseGuards(JwtAuthGuard)
  async getAdminTicketById(@Param("id") ticketId: string) {
    return this.service.getAdminTicketById(ticketId);
  }
