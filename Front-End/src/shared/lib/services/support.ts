...
export const SupportChatApi = {
  ...
  updateTicketStatus: async (
    ...
    return api<SupportTicket>(`/support-chat/admin/tickets/${ticketId}/status`, {
      method: "PATCH",
  ...
  /**
   * Get a specific ticket with all messages (admin route)
   */
  getAdminTicketById: async (ticketId: string) => {
    return api<SupportTicket>(`/support-chat/admin/tickets/${ticketId}`);
  },
